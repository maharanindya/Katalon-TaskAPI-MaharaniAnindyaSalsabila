...
Fokus pada verifikasi respon API, seperti:
...
**Cara Pakai**  
1. Clone repo ini: git clone https://github.com/maharanindya/Katalon-TaskAPI-MaharaniAnindyaSalsabila.git
2. Buka Katalon Studio, lalu Open Project.
3. Pilih folder hasil clone tadi.
4. Masuk ke folder Test Suites, pilih salah satu, dan klik Run.
